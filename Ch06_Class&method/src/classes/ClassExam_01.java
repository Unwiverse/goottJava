...
public class ClassExam_01 {
	 ...
	 * 객체 생성 시점에 해당 데이터 자료형에 맞게
	 * 알아서 해당 자료형의 default(기본)값을 설정해줌.
	 */

	 int num; //멤버변수 ==> 클래스 안에서 쓰이는 전역변수
	 char str; //멤버변수 ==> ""
	...
	public static void main(String[] args) {
			...
			//1. 단계 : 클래스 선언. 
							//형식) 클래스 이름 참조변수(클래스별칭);
//			ClassExam_01 exam;
			//2. 단계 : 클래스를 메모리(heap)에 생성. 
...
//			exam = new ClassExam_01();
			...
			//3단계: 참조변수를 이용해 객체에 접근.
			//			  객체에 접근 시 .(도트)를 이용해 접근.
			exam.display();
			System.out.println();
			exam.num = 147;
